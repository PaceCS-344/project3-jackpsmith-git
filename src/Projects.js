  ...
  <div className="p-6">
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="card">
          <img src={cataclysm} alt="Screenshot of Cataclysm Engine." height={200}></img>
        ...
        <div className="card">
          <img src={shaderSandbox} alt="Screenshot of Shader Sandbox." height={200}></img>
        ...
        <div className="card">
          <img src={pcr} alt="Screenshot of Point-Cloud Renderer." height={200}></img>
