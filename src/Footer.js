...
<div className="footer"><nav className="footercontent">
    <div className="flex-grid" style={{marginTop: 20, marginBottom: 60}}><div className="col">
        ...
        <div className="row" style={{ display: 'flex', alignItems: 'center' }}>
            <div className="shake"><a style={{ marginRight: 10 }} href="https://github.com/jackpsmith-git" target="_blank"><img src={github} height={40} style={{backgroundColor: 'white', maskImage: `url(${github})`, maskSize: 'contain', filter: 'brightness(0) invert(1)'}} /></a></div>
            <div className="shake"><a style={{ marginRight: 10 }} href="https://www.linkedin.com/in/jackpetersmith" target="_blank"><img src={linkedin} height={40} /></a></div>
