  ...
  <div style={{ display: 'flex', justifyContent: 'center' }}><div style={{ maxWidth: '1000px' }}><div className="p-6" style={{marginBottom: 40}}>
    ...
    <div className="floatingtile">
      ...
      <div className="row" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: 15 }}>
        <div className="shake"><a style={{ marginRight: 10 }} href="https://github.com/jackpsmith-git" target="_blank"><img src={github} height={40} /></a></div>
        ...
        <div className="shake"><a href="https://www.nuget.org/profiles/jackpsmith" target="_blank"><img src={nuget} height={40} /></a></div>
      </div>
    </div>
  </div></div></div>
);